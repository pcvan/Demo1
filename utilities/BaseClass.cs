...
namespace Demo1.utilities
{
    ...
    public class BaseClass
    {
        ...
        {
            var htmlReport = new ExtentHtmlReporter(@"C:\Users\mindc1may255\source\repos\Demo1\Demo1\Index.html");
            ...
            Log.Logger = new LoggerConfiguration().MinimumLevel.ControlledBy(levelSwitch: loggingLevel).WriteTo.File(@"C:\Users\mindc1may255\source\repos\Demo1\Demo1\logs",
                 outputTemplate: "{TimeSpan:YYYY-MM-dd HH:mm:ss.fff} | {Level:u3} | {Message}{NewLine}", rollingInterval: RollingInterval.Day).CreateLogger();
